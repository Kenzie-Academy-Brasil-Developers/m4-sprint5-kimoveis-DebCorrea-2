...
export class createJoinTableSchedules1662146058795 implements MigrationInterface {
    name = 'createJoinTableSchedules1662146058795'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "schedules_users_properties" ("id" uuid NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "propertyId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_751450246dee9abc82a47dabc4c" PRIMARY KEY ("id"))`);
